...
if __name__ == '__main__':
    ...
    image_path = "/home/ganch/GAN/LearningRateTest/"
    num_epochs = 26
    sess = tf.Session()
    width = 128
    height = 128
    with sess.as_default():
        ...
        loss_EG_OP = tf.train.AdamOptimizer(learning_rate = 0.001,beta1 = 0.5).minimize(loss_EG)
        loss_Dz_OP = tf.train.AdamOptimizer(learning_rate = 0.001,beta1 = 0.5).minimize(loss_Dz)
        loss_Di_OP = tf.train.AdamOptimizer(learning_rate = 0.001,beta1 = 0.5).minimize(loss_Di)
